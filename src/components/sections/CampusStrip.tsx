  ...
  return (
    <div className={styles.campusStrip}>
      <Link href="/campus#creche" className={styles.csBlock}>
        <div className={`${styles.csThumb} ${styles.teal}`}>📷</div>
        ...
        <span className={`${styles.csArrow} ${styles.teal}`}>→</span>
      </Link>

      <Link href="/campus#maternelle" className={styles.csBlock}>
        <div className={`${styles.csThumb} ${styles.pink}`}>📷</div>
        <div className={styles.csText}>
        ...
        <span className={`${styles.csArrow} ${styles.pink}`}>→</span>
      </Link>
    </div>
  )
}
